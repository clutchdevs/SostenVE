 ...
 */
export const ui = {
  /** Full-height public page canvas (the staff layouts set this on their shell). */
  page: 'min-h-screen bg-surface text-ink',
  /** Card / panel surface. */
  card: 'rounded-2xl border border-slate-200/80 bg-surface-card shadow-card',
  /** Text input / select. */
  field:
    'w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-ink placeholder:text-slate-400 outline-none transition-colors focus:border-brand focus:ring-1 focus:ring-brand',
  /** Primary action button. */
  primaryBtn:
    'rounded-xl bg-brand px-4 py-2.5 font-medium text-white transition-colors hover:bg-brand-dark disabled:opacity-50',
  ...
  /** Back / inline link. */
  link: 'text-sm font-medium text-brand hover:underline',
