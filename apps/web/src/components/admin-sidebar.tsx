...
// Every admin capability the platform exposes (we add, never remove): the new
// registration-exceptions and roster screens alongside the existing crisis-line,
// coordinator-invitation and audit features.
const NAV: NavItem[] = [
...
/** Fixed navy sidebar for the administration module. */
